...
def main():
    ...
    try:
        ...
        logreg.fit(ds[FEATURES], ds[LABEL], save_history=True)
        logreg.graph()
        logreg.fit(ds[FEATURES], ds[LABEL], save_history=True, method='stochastic', epochs=150)
        logreg.graph()
        logreg.fit(ds[FEATURES], ds[LABEL], save_history=True, method='minibatch', epochs=100)
        logreg.graph()
